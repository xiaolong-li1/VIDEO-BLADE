...
def _backward(ctx, do):
    ...
    grid_backward_1 = (triton.cdiv(k.shape[2], ctx.POOLING_BLOCK_N), ctx.grid[1])
    ...
    POOLING_BLOCK_N_2 = getattr(ctx, 'POOLING_BLOCK_N', ctx.POOLING_BLOCK_N) // 2
    ...
    POOLING_BLOCK_N_4 = getattr(ctx, 'POOLING_BLOCK_N', ctx.POOLING_BLOCK_N) // 4
    ...
    POOLING_BLOCK_N_8 = getattr(ctx, 'POOLING_BLOCK_N', ctx.POOLING_BLOCK_N) // 8
    ...
    dq = dq.to(do.dtype)
    print("dq.mean:",dq.mean())
    print("dk.mean:",dk_final.mean())
    print("dv_finnal:",dv_final.mean())
